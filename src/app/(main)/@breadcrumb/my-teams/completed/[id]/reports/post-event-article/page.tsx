// src/app/@breadcrumb/my-teams/active/[id]/participants/page.tsx
...
export default function ParticipantsBreadcrumbSlot() {
    ...
    return (
        <BreadcrumbList>
            ...
            <BreadcrumbItem>
                <BreadcrumbLink href="/my-teams/completed">Completed</BreadcrumbLink> {/* Correct href */}
            </BreadcrumbItem>
            <BreadcrumbSeparator />

            {/* Link to the specific event page, using the fetched name */}
            <BreadcrumbItem>
                 <BreadcrumbLink href={`/my-teams/completed/${eventId}`}>
            ...
            <BreadcrumbItem>
            <BreadcrumbLink href={`/my-teams/completed/${eventId}/reports`}>
                   Reports
                 </BreadcrumbLink>
            </BreadcrumbItem>
            ...
            <BreadcrumbItem>
                <BreadcrumbPage>Post Event Article</BreadcrumbPage> 
            </BreadcrumbItem>
