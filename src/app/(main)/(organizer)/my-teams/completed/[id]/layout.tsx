...
import CompletedTeamEventSidebar from '@/components/organizers/events/CompletedTeamEventSideBar';
...
export default function EventDetailLayout({
  ...
  return (
    <div className="flex items-stretch flex-1 event-content-panel-wrapper">
       ...
       <CompletedTeamEventSidebar /> {/* Pass nothing, it gets ID from useParams */}
