...
export default function EventParticipantsPage() {
    ...
    }, [eventId, currentPageNo, pageSize, fetchSavedParticipants]); // Re-run effect if eventId changes
    ...
    }, [uploadedParticipants, fetchDemographics]); // Run the effect when uploadedParticipants changes
