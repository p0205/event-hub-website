        ...
        <div className={styles["reports-container"]}>
          ...
          <div className={styles["report-card"]}>
            <div className={styles["report-header"]}>
              ...
              {reportOverview?.attendance?.attendanceReport?.generatedAt ? (
            ...
            <div className={styles["report-content"]}>
              ...
              {reportOverview?.attendance?.attendanceReport?.fileUrl && (
                <a
          ...
          <div className={styles["report-card"]}>
            <div className={styles["report-header"]}>
              <h2>💰 Budget Report</h2>
              {reportOverview?.budget?.budgetReport?.generatedAt ? (
                <span className={`${styles["status-badge"]} ${styles["status-generated"]}`}>
            ...
            <div className={styles["report-content"]}>
              <div className={styles["report-summary"]}>
                <div className={styles["summary-item"]}>
                  ...
                  <span className={styles["summary-value"]}>RM {reportOverview?.budget?.totalBudget?.toLocaleString() ?? '0'}</span>
                </div>
                <div className={styles["summary-item"]}>
                  <span className={styles["summary-label"]}>Total Expenses</span>
                  <span className={styles["summary-value"]}>RM {reportOverview?.budget?.totalExpenses?.toLocaleString() ?? '0'}</span>
                </div>
                <div className={styles["summary-item"]}>
                  <span className={styles["summary-label"]}>Remaining</span>
                  <span className={styles["summary-value"]}>RM {reportOverview?.budget?.remaining?.toLocaleString() ?? '0'}</span>
                </div>
              </div>
              {reportOverview?.budget?.budgetReport?.fileUrl && (
                <a
            ...
            <div className={styles["report-content"]}>
              <div className={styles["report-summary"]}>
                <div className={styles["summary-item"]}>
                  ...
                  <span className={styles["summary-value"]}>{reportOverview?.feedback?.averageRating?.toFixed(2) ?? '0'}/5</span>
                </div>
                <div className={styles["summary-item"]}>
                  <span className={styles["summary-label"]}>Total Feedback</span>
                  <span className={styles["summary-value"]}>{reportOverview?.feedback?.feedbackCount ?? 0}</span>
                </div>
              </div>
              <button
                ...
                <div className={styles["feedback-summary"]}>
                  ...
                  <div className={styles["rating-overview"]}>
                    <div className={styles["average-rating"]}>
                      <span className={styles["rating-number"]}>{reportOverview?.feedback?.averageRating?.toFixed(2) ?? '0'}</span>
                      {renderStarRating(reportOverview?.feedback?.averageRating ?? 0)}
                      <span className={styles["total-feedback"]}>({reportOverview?.feedback?.feedbackCount ?? 0} feedback entries)</span>
                    </div>
