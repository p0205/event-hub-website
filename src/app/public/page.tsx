...
interface Event {
  ...
  location: string;
  description: string;
  type: 'academic' | 'social' | 'workshop' | 'seminar';
  isPublic: boolean;
}
      ...
      <section id="home" className={styles.hero}>
        ...
        <div className={styles.heroContentRow}>
          ...
          <div className={styles.heroRight}>
            ...
            <img src="/ftmk-app-qr.png" alt="FTMK App QR Code" className={styles.heroQrImage} />
            ...
            <p className={styles.heroQrAltDownload}>
              Can't scan? Download <a href="/ftmk-app.apk" className="text-amber-700 hover:text-amber-800 font-semibold underline">Here</a>
            </p>
